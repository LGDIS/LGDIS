...
#sha ssh endpoint= "https://localhost:443/commons/subscriber/soap/testservice.example.com/"
#sha 
endpoint= "http://192.168.11.7/commons/subscriber/soap/testservice.example.com/"
