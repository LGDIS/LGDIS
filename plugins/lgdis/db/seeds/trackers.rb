...
ActiveRecord::Base.connection.execute(%{INSERT INTO trackers (position, id, name, is_in_chlog, is_in_roadmap, fields_bits) VALUES (73, 79, '【システム】公共情報コモンズ配信結果', false, true, 0)})
