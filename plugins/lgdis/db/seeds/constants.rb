...
Constant.create(kind1: 'TD', kind2: 'shelters', kind3: 'shelter_type', text: '広域避難場所:開設措置なし',  value: '3', _order: '3')
Constant.create(kind1: 'TD', kind2: 'shelters', kind3: 'shelter_type', text: '一時避難場所:開設措置なし',  value: '4', _order: '4')
# 開設状況
...
Constant.create(kind1: 'TD', kind2: 'evacuation_advisories', kind3: 'current_sort_criteria', text: '避難準備',   value: '3', _order: '3')
